//---------------MATRIZES IRREGULARES---------- (Matrizes não quadradas)
//Exercicio: Escreva um programa para guardar dados de uma pesquisa feita com uma amostra de pessoas. A pesquisa consiste em
//perguntar ao cidadão a quantidade de filhos e o nome de cada filho. Guarde essas informações numa matriz de forma que cada
//pessoa entrevistada ocupe somente o espaço necessário na memória para guardar o nome de seus filhos. Imprima a quantidade de
